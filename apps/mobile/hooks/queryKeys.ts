...
export const queryKeys = {
  ...
  seasonPoints: (userId: string) => ['seasonPoints', userId] as const,
  pointEvents: (userId: string) => ['pointEvents', userId] as const,
  referralCount: (userId: string) => ['referralCount', userId] as const,
};
