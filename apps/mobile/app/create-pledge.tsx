...
const CreatePledgeScreen = () => {
  ...
  // Set header title with translation
  useLayoutEffect(() => {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      // 1. Create on-chain pledge (pass USDC amount, not lamports - it converts internally)
      ...
      await createPledgeInDb.mutateAsync({
        ...
        stake_amount: parseUsdcToLamports(stakeAmount), // Store as lamports in DB
        todos: todoItems,
      });
...
export default CreatePledgeScreen;
